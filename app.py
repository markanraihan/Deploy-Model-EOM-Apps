...
# GCP Configuration
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "eom-firebase.json"  # Path ke service account key firebase
BUCKET_NAME = "eyes-on-me.firebasestorage.app"  # Ganti dengan nama bucket Anda
